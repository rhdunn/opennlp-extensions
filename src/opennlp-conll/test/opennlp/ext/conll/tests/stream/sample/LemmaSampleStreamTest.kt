...
@DisplayName("OpenNLP LemmaSample Stream")
class LemmaSampleStreamTest {
    private fun parse(text: String, properties: Properties = Properties()): List<LemmaSample> {
        val samples = LemmaSampleStream.create(text, SentenceStream.CONLLU, properties)
    ...
    inner class Sentences {
        ...
        fun single() {
            ...
            assertThat(samples[0].tokens, `is`(arrayOf("I", "like", "cars", ".")))
            assertThat(samples[0].tags, `is`(arrayOf("PRON", "VERB", "NOUN", "PUNCT")))
            assertThat(samples[0].lemmas, `is`(arrayOf("I", "like", "car", ".")))
        ...
        fun multiple() {
            ...
            assertThat(samples[1].tokens, `is`(arrayOf("We", "like", "them", ".")))
            assertThat(samples[1].tags, `is`(arrayOf("PRON", "VERB", "PRON", "PUNCT")))
            assertThat(samples[1].lemmas, `is`(arrayOf("we", "like", "they", ".")))
    ...
    inner class EmptyNode {
        ...
        fun copyOf() {
            ...
            assertThat(samples[0].tokens, `is`(arrayOf("I", "like", "cars", "and", "bikes", ".")))
            assertThat(samples[0].tags, `is`(arrayOf("PRON", "VERB", "NOUN", "CCONJ", "NOUN", "PUNCT")))
            assertThat(samples[0].lemmas, `is`(arrayOf("I", "like", "car", "and", "bike", ".")))
        ...
        fun typo() {
            ...
            assertThat(samples[0].tokens, `is`(arrayOf("As", "far", "as", "I", "know", ".")))
            assertThat(samples[0].tags, `is`(arrayOf("ADV", "ADV", "SCONJ", "PRON", "VERB", "PUNCT")))
            assertThat(samples[0].lemmas, `is`(arrayOf("as", "far", "as", "I", "know", ".")))
    ...
    inner class MultiTokenWordsTest {
        ...
        fun default() {
            ...
            assertThat(samples[0].tokens, `is`(arrayOf("I", "wan", "na", "go", "home", ".")))
            assertThat(samples[0].tags, `is`(arrayOf("PRON", "VERB", "PART", "VERB", "NOUN", "PUNCT")))
            assertThat(samples[0].lemmas, `is`(arrayOf("I", "want", "to", "go", "home", ".")))
        ...
        fun join() {
            ...
            assertThat(samples[0].tokens, `is`(arrayOf("I", "wanna", "go", "home", ".")))
            assertThat(samples[0].tags, `is`(arrayOf("PRON", "VERB+PART", "VERB", "NOUN", "PUNCT")))
            assertThat(samples[0].lemmas, `is`(arrayOf("I", "want to", "go", "home", ".")))
